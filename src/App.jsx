...
const NAV_PAGES = ["Home","Menu","About","Contact"];
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:60,alignItems:"center"}}>
            ...
            <div>
              ...
              <h1 style={{fontFamily:"'Orbitron',monospace",fontSize:"clamp(2.5rem,6vw,5rem)",fontWeight:900,lineHeight:1.05,marginBottom:24}}>
                <span style={{color:"#00f5ff",textShadow:"0 0 30px rgba(0,245,255,0.8)",display:"block"}} className="flicker">TASTE THE</span>
                <span style={{color:"#ff00aa",textShadow:"0 0 30px rgba(255,0,170,0.8)",display:"block"}}>FUTURE</span>
                <span style={{color:"#e0f4ff",display:"block"}}>OF DINING</span>
              </h1>
      ...
      <div style={{position:"relative",overflow:"hidden",background:"linear-gradient(135deg,#020408,#050112)",borderBottom:"1px solid rgba(0,245,255,0.1)",padding:"80px clamp(16px,4vw,60px)"}}>
        ...
        <div style={{maxWidth:1400,margin:"0 auto",position:"relative",zIndex:1}}>
          ...
          <p style={{fontFamily:"'Rajdhani',sans-serif",fontSize:"1.15rem",color:"rgba(224,244,255,0.6)",maxWidth:600,lineHeight:1.8}}>
            Born in the neon-drenched underground of Neo-Mumbai 2025, NEON BYTE is the world's first fully cyberpunk food experience. We fuse culinary science with street culture.
          </p>
        </div>
      </div>
